	        ...
	        <div class= address>
                <div class="line"></div>
		            <div class=addressContent>
			            ...
			            <form action="updateAddressStaff" method="post">
				            <table class="addressTab"  width=100% >
                                ...
                                <td colspan="3" style="padding: 15px 15px 15px 0px">
                                    <input type="text" id="addressL1" name="addressL1" placeholder="Address Line 1" th:value="${detailS[0].addressL1}" required>
                                </td>
                                </tr>
                                
                                <tr>
                                <td colspan="3" style="padding: 15px 15px 15px 0px">
                                    <input type="text" id="addressL2" name="addressL2" placeholder="Address Line 2" th:value="${detailS[0].addressL2}" required>
                                </td>
                                </tr>
                                
                                <tr>
                                <td colspan="3" style="padding: 15px 15px 15px 0px">
                                    <input type="text" id="addressL3" name="addressL3" placeholder="Address Line 3" th:value="${detailS[0].addressL3}" required>
                                </td>
                                </tr>
                                
                                <tr>
                                <td colspan="1" width=25% style="padding: 15px 15px 15px 0px">
                                    <input type="text" id="postcode" name="postcode" placeholder="Postcode" th:value="${detailS[0].postcode}" required>
                                </td>
                                <td colspan="1" width=40% style="padding: 15px 15px 15px 0px">
                                    <input type="text" id="city" name="city" placeholder="City" th:value="${detailS[0].city}" required>
                                </td>
                                <td colspan="1" width=33% style="padding: 15px 15px 15px 0px">
                                    <input type="text" id="state" name="state" placeholder="State" th:value="${detailS[0].state}" required>
                                </td>
                                </tr>
                            </table>			
