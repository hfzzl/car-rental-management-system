...
<div class="content-container">
	...
	<div class="content">
		...
		<div class="edit-button">
			<form method="post" action="viewAllStaff">
				<input type="submit" class="form-button2 fas fa-chevron-left" value="&#xf053; Back">
			</form>
			<form method="post" action="viewAddStaff">
