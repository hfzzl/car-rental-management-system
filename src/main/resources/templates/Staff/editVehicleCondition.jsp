...
<div class="content-container">
	...
	<div class="content">
		<div class="title">Edit Vehicle Condition</div>
		<div>Click on the appropiate action buttons.</div><br>
		
		<div class="edit-button">
			<form method="post" action="vehiclecondition">
				<input type="submit" class="form-button2 fas fa-chevron-left" value="&#xf053; Back">
			</form>
			<form method="post" action="viewAddVehicleCondition">
				...
				<tr th:each="vehicleCondition : ${vehicleCondition}">
					...
					<td>
						<div class="columnbttn">
							<form class="formbttn" method="post" action="viewUpdateVehicleCondition">
								<input type="hidden" name="VehicleConditionID" th:value="${vehicleCondition.VehicleConditionID}">
								<input type="submit" class="form-button fa fa-edit" value="&#xf044;" >
							</form>
							<form class="formbttn" method="post" action="deleteVehicleCondition">
								<input type="hidden" name="VehicleConditionID" th:value="${vehicleCondition.VehicleConditionID}">
