...
<div class="content-container">
	<div class="menu-sidebar">
		...
		<div class="nav-items2" id="boxAdmin"><a th:href="@{/viewAllStaff}">Manage Staff</a></div>
	...
	<div class="content">
		...
		<div>Insert the staff details and then click save.</div><br>
		...
		<div class="tableAdd">
				<table >
                    ...
                    <tr>
						<th>Password : </th>
						<td><input type="text" name="password" placeholder="Password..." style="width: 100%;"required></td>
					</tr>
					...
					<tr>
						<th>Fullname : </th>
						<td><input type="text" name="fullname" placeholder="Fullname..." style="width: 100%;"required></td>
					</tr>
                    <tr>
						<th>Birthdate : </th>
					...
					<tr>
						<th>Phone No. : </th>
						<td><input type="text" name="phone_no" placeholder="Phone No..." style="width: 100%;"required></td>
					</tr>
					<tr>
						<th>Email : </th>
						<td><input type="text" name="email" placeholder="Email..." style="width: 100%;"required></td>
					</tr>
					<tr>
						<th>Address Line 1 : </th>
						<td><input type="text" name="addressL1" placeholder="Address Line 1..." style="width: 100%;"required></td>
					</tr>
					<tr>
						<th>Address Line 2 : </th>
						<td><input type="text" name="addressL2" placeholder="Address Line 2..." style="width: 100%;"required></td>
					</tr>
                    <tr>
						<th>Address Line 3 : </th>
						<td><input type="text" name="addressL3" placeholder="Address Line 3..." style="width: 100%;"required></td>
					</tr>
                    <tr>
						<th>Postcode : </th>
						<td><input type="text" name="postcode" placeholder="Postcode..." style="width: 100%;"required></td>
					</tr>
                    <tr>
						<th>City : </th>
						<td><input type="text" name="city" placeholder="City..." style="width: 100%;"required></td>
					</tr>
                    <tr>
						<th>State : </th>
						<td><input type="text" name="state" placeholder="State..." style="width: 100%;"required></td>
					</tr>
