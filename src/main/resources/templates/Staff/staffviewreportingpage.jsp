						...
						<div class=addressContent>
							...
							<table class="addressTab" width=100%>
								...
								<tr >
									...
									<p>Daily Sales : RM50</p>
								</tr>
								
								<tr >
									<td colspan="3" style="padding: 15px 15px 15px 0px" >New Customer : 5
									</td>
								</tr>

								<tr >
									<td colspan="3" style="padding: 15px 15px 15px 0px" >Active Customer :15
									</td>
								</tr>
							...
							<table class="addressTab" width=100%>
								...
								<tr >
									<td colspan="3" style="padding: 15px 15px 15px 0px" >
										<label>Monthly Sales : RM2000</label>
									</td>
								</tr>

								<tr >
									<td colspan="3" style="padding: 15px 15px 15px 0px" >New Customer : 50
									
									</td>
								</tr>

								<tr >
									<td colspan="3" style="padding: 15px 15px 15px 0px" >Active Customer : 150
									</td>
								</tr>
				...
				<div class=profile2>
					<div class=profileContent>
						<table class="profileTab" width="100%">
							...
							<tr>
								<td style="text-align: center" colspan="3"> <h3>M Shafiq bin Sahdann</h3></td>
							</tr>

							<tr >
								<td colspan="2" width="90%" >
									<h3>Achievements : he gathered the most new customers this month</h3>
								</td>
							</tr>
