...
<div class="content-container">
	...
	<div class="content">
        <div class="title">Booking Form</div>
            <form class="bookingForm" method="post" action="addBookingStaff">
                <div class="leftSide">
                    <div class="leftContent">
                        <table class="leftTable">
                            ...
                            <tr>
                                <td class="left" colspan="2">
                                    <input type="text" id="custPhoneNo" name="custPhoneNo"  placeholder="Phone No..."   required>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="left" colspan="2">
                                    <input type="text" id="custEmail" name="custEmail"  placeholder="Email Address..."  required>
                                </td>
                            </tr>
                            <tr></tr>
