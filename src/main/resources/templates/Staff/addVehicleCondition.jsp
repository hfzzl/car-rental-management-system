...
<div class="content-container">
	...
	<div class="content">
		<div class="title">Add Vehicle Condition</div>
		<div>Insert the condition details and then click save.</div><br>

		<div class="edit-button">
			<form method="post" action="viewEditVehicleCondition">
				<input type="submit" class="form-button2 fas fa-chevron-left" value="&#xf053; Back">
			</form>
			<form method="post" action="addVehicleCondition">
		...
		<div class="table">
			<table class="my-table w3-table w3-striped w3-bordered">
				...
				<tr>
					<td><input type="text" name="Condition" placeholder="Conditions are.." required></td>
					<td><input type="text" name="Action" placeholder="Actions are.." required></td>
					<td><input type="date" name="ActionDate" placeholder="Date is.." required></td>
				</tr>
