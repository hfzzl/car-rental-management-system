...
<div class=leftbox>
	<div class=profile2>
		...
		<form action="updateProfileStaff" method="post">
		...
		<td colspan="2" width ="70%" style="padding: 15px 15px 15px 0px">
            ...
            <input type="text" id="fullname" name="fullname" placeholder="Full name" th:value="${detailS[0].fullname}" required>
		</td>
		...
		<td colspan="3" style="padding: 15px 15px 15px 0px">
            <input type="text" id="phoneNo" name="phoneNo" placeholder="Phone Number" th:value="${detailS[0].phone_no}" required>
		</td>
		</tr>
		
		<tr>
		<td colspan="3" style="padding: 15px 15px 15px 0px">
            <input type="text" id="email" name="email" placeholder="Email Address" th:value="${detailS[0].email}" required>
		</td>
		</tr>
