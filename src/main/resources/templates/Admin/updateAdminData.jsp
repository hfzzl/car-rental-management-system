...
<div class="content-container">
	...
	<div class="content">
		...
		<div>Update the admin details and then click save.</div><br>
		...
		<div class="tableAdd">
			<form method="post" action="updateAdmin">
				<table>
					...
					<tr>
						<th>Fullname : </th>
						<td><input type="text" name="fullname" th:value="${admin[0].fullname}" style="width: 100%;" required></td>
					</tr>
					<tr>
						<th>Phone No. : </th>
						<td><input type="text" name="phone_no" th:value="${admin[0].phone_no}" style="width: 100%;"required></td>
					</tr>
					<tr>
						<th>Email : </th>
						<td><input type="text" name="email" th:value="${admin[0].email}" style="width: 100%;"required></td>
					</tr>
					<tr>
						<th>Address Line 1 : </th>
						<td><input type="text" name="addressL1" th:value="${admin[0].addressL1}" style="width: 100%;"required></td>
					</tr>
					<tr>
						<th>Address Line 2 : </th>
						<td><input type="text" name="addressL2" th:value="${admin[0].addressL2}" style="width: 100%;"required></td>
					</tr>
                    <tr>
						<th>Address Line 3 : </th>
						<td><input type="text" name="addressL3" th:value="${admin[0].addressL3}" style="width: 100%;"required></td>
					</tr>
                    <tr>
						<th>Postcode : </th>
						<td><input type="text" name="postcode" th:value="${admin[0].postcode}" style="width: 100%;"required></td>
					</tr>
                    <tr>
						<th>City : </th>
						<td><input type="text" name="city" th:value="${admin[0].city}" style="width: 100%;"required></td>
					</tr>
                    <tr>
						<th>State : </th>
						<td><input type="text" name="state" th:value="${admin[0].state}" style="width: 100%;"required></td>
					</tr>
					<tr>
						<td><input type="hidden" name="userid" th:value="${admin[0].userid}" ></td>
					</tr>
					<tr>
