...
<div class="content-container">
	...
	<div class="content">
		...
		<div>Update the promotion details and then click save.</div><br>
		...
		<div class="table">
			<form method="post" action="updatePromotion">
				<table>
					<tr>
						<td><input type="hidden" name="promotionid" th:value="${promotion[0].promotionid}"></td>
					</tr>
					<tr>
						<th>Name</th>
						<td><input type="text" name="name" th:value="${promotion[0].name}" required></td>
					</tr>
					<tr>
						<th>Description</th>
						<td><input type="text" name="description" th:value="${promotion[0].description}" required></td>
					</tr>
					<tr>
						<th>Percentage</th>
						<td><input type="text" name="percentage" th:value="${promotion[0].percentage}" required></td>
					</tr>
					<tr>
