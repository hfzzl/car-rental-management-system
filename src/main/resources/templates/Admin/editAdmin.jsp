...
<div class="content-container">
	...
	<div class="content">
		...
		<div class="edit-button">
			<form method="post" action="viewAllAdmin">
				<input type="submit" class="form-button2 fas fa-chevron-left" value="&#xf053; Back">
			</form>
			<form method="post" action="viewAddAdmin">
				...
				<tr th:each="admin : ${admin}">
                    ...
                    <td>
						<div class="columnbttn">
							<form class="formbttn" method="post" action="viewUpdateAdmin">
								<input type="hidden" name="userid" th:value="${admin.userid}">
								<input type="submit" class="form-button fa fa-edit" value="&#xf044;" >
							</form>
							<form class="formbttn" method="post" action="deleteAdmin">
								<input type="hidden" name="userid" th:value="${admin.userid}">
